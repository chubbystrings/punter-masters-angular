...
export class HeaderComponent implements OnDestroy {
  ...
  scrollValue = 0;
  headerClass = 'z-10 transition ease-in-out duration-500 py-[5px] px-[32px] md:px-[64px] lg:px-[120px] 2xl:px-[24px]  bg-light  flex justify-between items-center fixed top-0 w-full 2xl:w-[1200px] left-1/2 transform -translate-x-1/2 ';
  condHeader = ''
